import pandas as pd
import numpy as np
from Staroverov_neural import MLPptorch
from Staroverov_neural import MLPptorch_Staroverov
import torch
...
net_relu = MLPptorch_Staroverov(inputSize,hiddenSizes,outputSize)
